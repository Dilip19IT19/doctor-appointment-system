              ...
              {isLoading ? <ThreeDots width={50} height={50} color={'#4361ee'}/> : 
                <ScrollArea>
                  <div className='md:w-[400px] w-[250px] h-[250px] md:h-[400px] px-3 flex flex-col gap-2 items-center '>
                    ...
                    return (
                      <Link key={doctor.id} className='border-secondary shadow-md transition-all border-[1px] hover:border-none  cursor-pointer active:scale-95 hover:bg-secondary flex  items-center justify-start gap-2 w-full p-2 rounded-md md:rounded-xl' href={`/details/${doctor.id}`}>
