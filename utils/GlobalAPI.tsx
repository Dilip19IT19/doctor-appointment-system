...
export default {getCategory,getDoctors,getDoctorsByCategory,getDoctorById,createAppointment,sendEmail,getAppointmentsList,deleteAppointment,getLimitedDoctors,updateAppointment};