...
function AboutPage() {
  ...
  <h1 className=' text-lg font-bold text-primary mt-4 mb-2'>Our Mission</h1>

  <p>
  At the core of our project is a commitment to improving access to healthcare services by simplifying the appointment booking process. We strive to empower users to easily schedule appointments with their preferred doctors, reducing wait times and ensuring timely access to quality healthcare.
